...
namespace SingletonClientSample.Client
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Call bound action to reset singleton
            clientContext.Execute(new Uri(clientContext.BaseUri + "/Employees/WebStack.QA.Test.OData.Singleton.ResetDataSource"), "POST");
            ...
            Employee newEmployee1 = new Employee() { ID = 4321, Name = "NewHired1" };
            clientContext.AddRelatedObject(company, "Employees", newEmployee1);
            clientContext.SaveChanges();

            //Add navigation link based on existing entity
            Employee newEmployee2 = new Employee() { ID = 1212, Name = "NewHired2" };
